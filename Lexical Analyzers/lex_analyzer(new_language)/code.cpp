...
{
    if (!strcmp(str, "condition") || !strcmp(str, "otherwise") ||
        !strcmp(str, "whiile") || !strcmp(str, "ddo") ||
        !strcmp(str, "break") ||  !strcmp(str, "conntinue")
        || !strcmp(str, "integer") || !strcmp(str, "doubble")
        || !strcmp(str, "floatt") || !strcmp(str, "give")
        || !strcmp(str, "charac") || !strcmp(str, "casse")
        || !strcmp(str, "long") || !strcmp(str, "shortt")
        || !strcmp(str, "typedef") || !strcmp(str, "switchh")
        || !strcmp(str, "unsiggned") || !strcmp(str, "voiid")
        || !strcmp(str, "stattic") || !strcmp(str, "struuct")
        || !strcmp(str, "sizzeof") || !strcmp(str,"longg")
        || !strcmp(str, "vollatile") || !strcmp(str, "typpedef")
        || !strcmp(str, "enumm") || !strcmp(str, "constt")
        || !strcmp(str, "start_loop") || !strcmp(str, "exxtern")
        || !strcmp(str,"bool"))
        {
            return true;
        }
...
int main()
{
    cout<<"Enter a statement to parse"<<endl;
    char c[100];
    gets(c);
    parse(c);
    return 0;
